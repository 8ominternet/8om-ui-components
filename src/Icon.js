...
class Icon extends React.Component {
  render() {
	...
	c1,0,1.7-0.7,1.8-1.6l0,0C8.8,6,9.1,5.4,9.7,4.8c1.6-1.6,4.1-1.6,5.7,0s1.6,4.1,0,5.7c-0.8,0.8-1.7,1.2-2.8,1.2
	c-0.3,0-0.5,0.2-0.5,0.5v5.9c0,0.3,0.2,0.5,0.5,0.5H15c0.3,0,0.5-0.2,0.5-0.5v-3.6c0.8-0.3,1.7-0.9,2.3-1.6c1.4-1.4,2.2-3.3,2.2-5.3
	S19.2,3.8,17.8,2.3z M17.2,12.2c-0.7,0.7-1.5,1.2-2.2,1.5l-0.3,0.2c-0.1,0.1-0.1,0.2-0.1,0.3v3.4H13v-4.9c1.2-0.1,2.2-0.6,3-1.4
	c2-2,2-5.1,0-7.1s-5.1-2-7.1,0c-0.6,0.6-1,1.3-1.3,2.2c0,0.1,0,0.1,0,0.2c0,0.4-0.4,0.7-0.8,0.7S6.1,6.9,6.1,6.6l0,0
	C6.3,5.3,6.9,4.1,8,3c1.2-1.2,2.8-1.9,4.6-1.9S16,1.8,17.2,3C18.4,4.3,19,5.9,19,7.6S18.4,11,17.2,12.2z"
            />
          </svg>
        )
      },
	...
	c0,0,1.3-2.7,0.9-3.2c0,0-0.5-1.3-2.1,0.2c0.1,0,1.8-0.5,0.4,1.8c0,0-1.4,2,0.3,2.3c0,0,0.9,0.2,1.4-0.6C8.1,9.9,6.8,10,7,9.3z"
            />
          </svg>
        )
      },
